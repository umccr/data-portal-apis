...
class LabMetadataSyncSerializer(serializers.Serializer):
    sheets = serializers.ListField(default=['2019', '2020', '2021', '2022', '2023', '2024', '2025'])  # OpenAPI swagger doc hint only
...
class FastqListRowSerializer(serializers.ModelSerializer):
    class Meta:
        model = FastqListRow
        fields = '__all__'


class SequenceRunSerializer(serializers.ModelSerializer):
    class Meta:
        model = SequenceRun
        fields = '__all__'
...
class LibraryRunModelSerializer(serializers.ModelSerializer):
    class Meta:
        model = LibraryRun
        fields = '__all__'
