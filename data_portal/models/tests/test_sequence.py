...
class SequenceTestCase(TestCase):
    ...
    def test_get_sequence(self):
        """
        python manage.py test data_portal.models.tests.test_sequence.SequenceTestCase.test_get_sequence
        """
        build_mock()
    ...
    def test_from_seq_run_status(self):
        """
        python manage.py test data_portal.models.tests.test_sequence.SequenceTestCase.test_from_seq_run_status
        """
    ...
    def test_from_seq_run_status_stopped(self):
        """
        python manage.py test data_portal.models.tests.test_sequence.SequenceTestCase.test_from_seq_run_status_stopped
        """
    ...
    def test_from_seq_run_status_no_match(self):
        """
        python manage.py test data_portal.models.tests.test_sequence.SequenceTestCase.test_from_seq_run_status_no_match
        """
        try:
