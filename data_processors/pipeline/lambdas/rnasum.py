...
def handler(event, context) -> dict:
    ...
    library_id = event['library_identifier']
    ...
    workflow_input['dataset'] = event['dataset']
    workflow_input['report_directory'] = event['report_directory']
    workflow_input['sample_name'] = event['sample_name']
    ...
    workflow_run_name = wfl_helper.construct_workflow_name(subject_id=subject_id, sample_name=sample_name)
