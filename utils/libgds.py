...
Example usage:
 - See unit test cases in utils/tests/test_libgds.py
 - See Django standalone app in data_processors/scripts/gdscrawler.py
"""
import copy
import logging
import os
...
def _paginated_list(ep, headers, **kwargs):
    ...
    logger.debug(params, kwargs.keys())
