...
class LibGDSUnitTests(TestCase):
    ...
    def test_list_files_local(self):
        ...
        python -m unittest utils.tests.test_libgds.LibGDSUnitTests.test_list_files_local > out.log
        """
    ...
    def test_get_file_local(self):
        ...
        python -m unittest utils.tests.test_libgds.LibGDSUnitTests.test_get_file_local > out.log
        """
    ...
    def test_list_volumes_local(self):
        ...
        export IAP_BASE_URL=<baseUrl>
        export IAP_AUTH_TOKEN=<tok>
        python -m unittest utils.tests.test_libgds.LibGDSUnitTests.test_list_volumes_local > out.log
        """
    ...
    def test_get_volume_local(self):
        ...
        python -m unittest utils.tests.test_libgds.LibGDSUnitTests.test_get_volume_local > out.log
        """
        iap_gds_volume = os.getenv('IAP_GDS_VOLUME', None)
        assert iap_gds_volume is not None, "IAP_GDS_VOLUME is not defined"
