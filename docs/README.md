...
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/lims?subject=SBJ00700 | jq
```

_Get LIMS record(s) by Sequence Run:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/lims?run=200612_A01052_0017_BH5LYWDSXY | jq
```

_Search LIMS record(s) by Library ID:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/lims?search=L2000176 | jq
```
...
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/metadata | jq
```

_Get a Metadata record:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/metadata/10 | jq
```

_Get Metadata record(s) by Subject:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/metadata?subject=SBJ00700 | jq
```

_Get Metadata record(s) by Subject, Assay Type, Phenotype:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/metadata?phenotype=tumor&type=wgs&subject=SBJ00700 | jq
```
...
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/gds | jq
```

_Get a GDS file record:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/gds/10 | jq
```

_Get PreSigned URL of this GDS file record:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/gds/10/presign | jq
```

_List GDS file entries belongs to Sequence Run:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/gds?run=200612_A01052_0017_BH5LYWDSXY | jq
```

_Search Fastq GDS files entries by Sequence Run:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/gds?run=200612_A01052_0017_BH5LYWDSXY&search=.fastq.gz$ | jq
```
...
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/workflows | jq
```

_Get a Workflow record:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/workflows/800 | jq
```

_Get Workflow record(s) by Sequence Run:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/workflows?run=200612_A01052_0017_BH5LYWDSXY | jq
```
...
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/reports | jq > reports.json
```

_Get a Report record by Subject:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/reports?subject=SBJ00700 | jq > reports_SBJ00700.json
```

_Get a Report record by Subject, Report Type:_
```
curl -s -H "Authorization: Bearer $PORTAL_TOKEN" https://api.data.dev.umccr.org/reports?subject=SBJ00700&type=hrd_hrdetect | jq
```
